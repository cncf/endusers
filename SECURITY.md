...
- Email the maintainer listed on [MAINTAINERS.md](./MAINTAINERS.md) if private
...
in this repository. Vulnerabilities in third-party dependencies should also be
reported here if no fixed version is available — Dependabot and automated
scanning handle routine dependency advisories.
