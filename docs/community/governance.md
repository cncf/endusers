...
title: Governance
sidebar_position: 2
description: How CNCF User Groups, Initiatives, and Technical Community Groups are governed.
---
...
It is a living document and is expected to change and be refined as User
Groups take shape.

The CNCF User Groups are comprised of four types of groups that serve
...
is tightly scoped and time-bound. Initiatives are typically run and staffed
from within the UG, with the TAB governing the initiative proposals and
ensuring correct alignment and duration.

**Technical Community Group:** A lightweight topic or domain-focused group
used to serve as a rallying point for community members to discuss, share
knowledge, and coordinate potential future initiatives.
