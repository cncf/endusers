...
This directory contains only organization-level information curated from
authoritative CNCF sources. It does not publish personal contact details or
unverified claims. Each profile links back to its original sources so you can
verify the underlying announcements and architecture submissions.

Want your organization listed? Contribute a
[reference architecture](https://github.com/cncf/tab/blob/main/process/reference-architectures.md)
or nominate an end user for the
[Top End User Award](https://www.cncf.io/enduser/).
