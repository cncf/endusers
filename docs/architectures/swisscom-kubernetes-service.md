...
## Relevant CNCF projects
  ...
  <CNCFProjectCard name="KubeVirt" href="https://www.cncf.io/projects/kubevirt/" since="2024" version="v1.5.0 (CNIP)" description="- Cluster resources are constructed using KubeVirt for virtual machine abstraction of Control Plane and Worker instances." />

  <CNCFProjectCard name="Kube-OVN" href="https://www.cncf.io/projects/kube-ovn/" since="2024" version="v1.13.14 (CNIP)" description="- Kube-OVN is utilized as network stack of the infrastructure cluster to enable intra-cluster/east-west network communication of user clusters. It enables a policy-driven security model as well as customer network isolation using VPCs." />

  <CNCFProjectCard name="MetalLB" href="https://www.cncf.io/projects/metallb/" since="2024" version="v0.15.3" description="- MetalLB is an integral component of the infrastructure deployment process, offering automated access to the framework that provisions individual user cluster resources on bare metal Kubernetes environments." />

  <CNCFProjectCard name="Container Storage Interface (CSI)" href="https://www.cncf.io/projects/container-storage-interface-(csi)/" since="2024" version="v25.06.3 (trident-csi)" description="- Kubevirt-CSI is the standard storage interface for persistent volumes in user clusters. Trident-CSI manages NetApp storage requests and can also be used directly to integrate with Swisscom's File Service Kubernetes, which provides iSCSI and NFS shared storage across all Availability Zones." />

  <CNCFProjectCard name="Kyverno" href="https://www.cncf.io/projects/kyverno/" since="2024" version="v1.13.4 (CNIP)" description="- Kyverno serves as the default policy engine for infrastructure and user clusters, providing robust security constraints. In addition to Kyverno, also Chainsaw (a Kyverno sub-project) is used for automated, declarative e2e testing." />

  <CNCFProjectCard name="ArgoCD" href="https://www.cncf.io/projects/argo/" since="2024" version="v3.2.0 (CNIP)" description="- ArgoCD allows us to deliver comprehensive infrastructure using a fully automated GitOps methodology." />

  <CNCFProjectCard name="Helm" href="https://www.cncf.io/projects/helm/" since="2024" version="v3.5.1 (CNIP)" description="- Helm automates the creation, packaging, configuration, and deployment of Kubernetes applications by creating reusable charts." />
